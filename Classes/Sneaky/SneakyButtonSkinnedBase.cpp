...
SneakyButtonSkinnedLayer::~SneakyButtonSkinnedLayer()
{
	if (defaultSprite)
	{
...
bool SneakyButtonSkinnedLayer::init() //Possible errors here
{
	bool pRet = false;
	if(CCLayer::init()){
		...
		this->schedule(schedule_selector(SneakyButtonSkinnedLayer::watchSelf));
		pRet = true;
	}
	return pRet;
}

void SneakyButtonSkinnedLayer::watchSelf(float delta) //Be Careful Here
{
...
void SneakyButtonSkinnedLayer::setContentSize(CCSize s)
{
...
void SneakyButtonSkinnedLayer::setDefaultSprite(CCSprite *aSprite)
{
	if(defaultSprite){
...
void SneakyButtonSkinnedLayer::setActivatedSprite(CCSprite *aSprite)
{
	if(activatedSprite){
...
void SneakyButtonSkinnedLayer::setDisabledSprite(CCSprite *aSprite)
{
	if(disabledSprite){
...
void SneakyButtonSkinnedLayer::setPressSprite(CCSprite *aSprite)
{
	if(pressSprite){
...
void SneakyButtonSkinnedLayer::setButton(SneakyButton *aButton)
{
	if(button){
		if(button->getParent())
